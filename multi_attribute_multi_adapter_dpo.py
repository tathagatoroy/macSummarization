...
#CUDA_VISIBLE_DEVICES=0, python multi_attribute_multi_adapter_dpo.py --debug | tee output.txt

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--config_path", type=str, default="/home2/tathagato/summarization/MACSUM/naacl/configs/multi_attribute_multi_adapter_dpo.yaml")
    ...
    old_adapter_name = experiment_config["attributes"][0]
    new_adapter_name = experiment_config['attributes'][1]
    model = load_dpo_adapter_model(config, quantization_config=bnb_config,adapter_name=old_adapter_name)
